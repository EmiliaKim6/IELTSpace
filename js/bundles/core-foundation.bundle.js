...
(function(window) {
    ...
    class BaseRepository {
        ...
        async read(options = {}) {
            ...
            let value = (sourceValue === undefined || sourceValue === null) ? resolvedDefault : sourceValue;
    ...
    function bootstrap() {
        ...
        const metaRepo = new ExamData.MetaRepository(dataSource, {
            ...
            vocab_active_list_id: {
                ...
                validators: [
                    (value) => typeof value === 'string' || 'vocab_active_list_id 必须为字符串'
                ],
                cloneOnRead: false
            },
            vocab_list_p1_errors: {
                ...
                validators: [
                    (value) => (
                        ...
                        || Array.isArray(value)
                        || (value && typeof value === 'object' && Array.isArray(value.words))
                    ) || 'vocab_list_p1_errors 必须为数组或词表对象'
                ]
            },
            vocab_list_p4_errors: {
                ...
                validators: [
                    (value) => (
                        ...
                        || Array.isArray(value)
                        || (value && typeof value === 'object' && Array.isArray(value.words))
                    ) || 'vocab_list_p4_errors 必须为数组或词表对象'
                ]
            },
            vocab_list_master_errors: {
                ...
                validators: [
                    (value) => (
                        ...
                        || Array.isArray(value)
                        || (value && typeof value === 'object' && Array.isArray(value.words))
                    ) || 'vocab_list_master_errors 必须为数组或词表对象'
                ]
            },
            vocab_list_custom: {
                defaultValue: () => [],
